...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_timer2.default, null), document.getElementById('clock'));
	...
	var Timer = function (_React$Component) {
		...
		_createClass(Timer, [{
			...
			value: function update() {
				var hex = '#' + this.state.getTime('hours') + this.state.getTime('mins') + this.state.getTime('secs');
